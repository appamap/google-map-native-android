...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event {
  if (self.clickable == NO ||
    ...
    float offsetX = 0;//self.webView.scrollView.contentOffset.x;// + self.mapCtrl.view.frame.origin.x;
    float offsetY = 0;//self.webView.scrollView.contentOffset.y;// + self.mapCtrl.view.frame.origin.y;
